...
void pollard_rho(mpz_t factor, const mpz_t n,
    ...
    if (time(NULL) - start_time >= 300) {/////////////////////////////////////////////////////////////////////TIMEOUT 1 di 5
        *timeout_flag = 1;
        return;
    }
...
void factor_pollard(mpz_t n, factor_t *factors, int *nf, int max_factors,
    ...
    if (*timeout_flag) return;
    if (time(NULL) - start_time >= 300) {////////////////////////////////////////////////////////TIMEOUT 2 di 5
        *timeout_flag = 1;
        return;
    }
...
void factor_ecm_single(mpz_t n, factor_t *factors, int *nf, int max_factors,
    ...
    if (*timeout_flag) return;
    if (time(NULL) - start_time >= 300) {//////////////////////////////////////////////////////////TIMEOUT 3 di 5
        *timeout_flag = 1;
        return;
    }
...
void factor_recursive(mpz_t n, factor_t *factors, int *nf, int max_factors,
    ...
    if (*timeout_flag) return;
    if (time(NULL) - start_time >= 300) {///////////////////////////////////////////////////////TIMEOUT 4 di 5
        *timeout_flag = 1;
        return;
    }
...
void search_divisors(
    ...
    if (*timeout_flag) return;
    if (time(NULL) - start_time >= 300) {////////////////////////////////////////////////////////// TIMEOUT 5 di 5
        *timeout_flag = 1;
        return;
    }
