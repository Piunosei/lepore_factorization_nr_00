...
void pollard_rho(mpz_t factor, const mpz_t n,
    ...
    if (time(NULL) - start_time >= 3600) {/////////////////////////////////////////////////////////////////////TIMEOUT 1 di 5
        *timeout_flag = 1;
        return;
    }
...
void factor_pollard(mpz_t n, factor_t *factors, int *nf, int max_factors,
    ...
    if (*timeout_flag) return;
    if (time(NULL) - start_time >= 3600) {////////////////////////////////////////////////////////TIMEOUT 2 di 5
        *timeout_flag = 1;
        return;
    }
...
void factor_ecm_single(mpz_t n, factor_t *factors, int *nf, int max_factors,
    ...
    if (*timeout_flag) return;
    if (time(NULL) - start_time >= 3600) {//////////////////////////////////////////////////////////TIMEOUT 3 di 5
        *timeout_flag = 1;
        return;
    }
...
int factor_H_special(mpz_t n, factor_t *factors, int *nf, int max_factors) {
    ...
    if (mpz_cmp_ui(z, 1) != 0 && mpz_cmp(z, n) != 0) {
        ...
        add_factor(factors, nf, max_factors, q, 1);
...
void factor_recursive(mpz_t n, factor_t *factors, int *nf, int max_factors,
    ...
    if (*timeout_flag) return;
    if (time(NULL) - start_time >= 3600) {///////////////////////////////////////////////////////TIMEOUT 4 di 5
        *timeout_flag = 1;
        return;
    }
...
void search_divisors(
    ...
    if (*timeout_flag) return;
    if (time(NULL) - start_time >= 3600) {////////////////////////////////////////////////////////// TIMEOUT 5 di 5
        *timeout_flag = 1;
        return;
    }
